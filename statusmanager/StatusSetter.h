...
public:
    ...
    virtual bool isCellularServiceShown() = 0;
    virtual void showCellularService(bool shown) = 0;
    virtual bool isSecondaryCellularServiceShown() = 0;
    virtual void showSecondaryCellularService(bool shown) = 0;
