...
void StatusSetter16::unsetCellularService()
{
    StatusBarOverrideData *overrides = getOverrides();
...
bool StatusSetter16::isSecondaryCellularServiceOverridden()
{
    StatusBarOverrideData *overrides = getOverrides();
